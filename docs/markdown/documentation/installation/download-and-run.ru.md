...
Скопируйте минимальный пример в рабочий файл. Он открывает категорию
**System Status** с тремя кнопками только для чтения: Uptime, Memory и
Disk Space. Кнопки для произвольной команды нет.
